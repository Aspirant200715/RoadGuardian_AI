...
export const Heatmap = () => {
  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto h-[calc(100vh-8rem)] flex flex-col">
      <div className="bg-[#000080] text-white border-b-4 border-[#FF9933] shadow-md dark:bg-[#0a0a1a] rounded-t-sm shrink-0">
        <div className="px-6 py-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[#FF9933] text-xs tracking-[0.1em] uppercase mt-0.5 font-bold">
                National Geospatial Analytics Portal
              </p>
            </div>
          </div>
          <div className="flex items-center text-[10px] font-mono font-bold uppercase tracking-wider bg-white/10 border border-white/30 px-3 py-1.5 text-white shadow-sm rounded-sm">
            <Map className="w-3.5 h-3.5 mr-2" /> SECTOR: NATIONAL (INDIA)
          </div>
        </div>
      </div>
