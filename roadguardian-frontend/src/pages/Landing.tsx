        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8 space-y-6">
           ...
           <div className="lg:col-span-12 lg:order-last space-y-6 mt-4">
             ...
             <div className="bg-white dark:bg-card border-t-4 border-t-[#000080] dark:border-t-primary shadow-sm rounded-sm overflow-hidden mt-6 border-x border-b border-border">
               <div className="bg-slate-50 dark:bg-slate-900/50 p-4 border-b border-border flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                 <div className="flex items-center gap-3">
                   <div className="bg-[#000080]/10 p-2 rounded-sm border border-[#000080]/20">
                     <Radar className="w-5 h-5 text-[#000080] dark:text-primary" />
                   </div>
                   <div>
                     <h3 className="font-black text-sm uppercase tracking-wider text-[#000080] dark:text-primary">
                       National Satellite Telemetry Sweep
                     </h3>
                     <p className="text-[10px] uppercase font-bold text-slate-500 mt-0.5 tracking-widest">
                       Data Classification: Official Public Use | Node: ISRO-EOS-04
                     </p>
                   </div>
                 </div>
                 <div className="flex items-center gap-2 bg-emerald-50 dark:bg-emerald-950/30 px-3 py-1.5 border border-emerald-200 dark:border-emerald-900/50 rounded-sm">
                   <span className="relative flex h-2 w-2">
                     <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-500 opacity-75"></span>
                     <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-600"></span>
                   </span>
                   <span className="text-[10px] font-black uppercase text-emerald-700 dark:text-emerald-500 tracking-wider">Live Sentinel Nodes</span>
                 </div>
               </div>
               ...
               <div className="p-4 grid grid-cols-1 lg:grid-cols-12 gap-6">
                 ...
                 <div className="lg:col-span-7 space-y-3">
                   <h4 className="text-[11px] font-bold uppercase text-slate-600 dark:text-slate-400 border-b border-border pb-1.5 flex items-center gap-1.5">
                     <Map className="w-3.5 h-3.5" /> Designated Scanning Regions
                   </h4>
                   
                   <div className="overflow-x-auto border border-border rounded-sm">
                     <table className="w-full text-left text-xs font-mono">
                       <thead className="bg-slate-50 dark:bg-muted text-[9px] uppercase text-slate-500">
                         <tr>
                           <th className="px-3 py-2 font-bold border-b border-r border-border">Corridor ID</th>
                           <th className="px-3 py-2 font-bold border-b border-border">GPS Coordinates (N/E)</th>
                           <th className="px-3 py-2 font-bold border-b border-border text-center">Status</th>
                         </tr>
                       </thead>
                       <tbody className="divide-y divide-border">
                         <tr className="hover:bg-slate-50 dark:hover:bg-muted/50 transition-colors">
                           <td className="px-3 py-2 border-r border-border font-bold text-[#000080] dark:text-primary">NH-44 (North-South)</td>
                           <td className="px-3 py-2 text-slate-600 dark:text-slate-400">28.6139° N, 77.2090° E</td>
                           <td className="px-3 py-2 text-center text-emerald-600 dark:text-emerald-400 font-bold">Scanning</td>
                         </tr>
                         <tr className="hover:bg-slate-50 dark:hover:bg-muted/50 transition-colors">
                           <td className="px-3 py-2 border-r border-border font-bold text-[#000080] dark:text-primary">NH-48 (Golden Quad)</td>
                           <td className="px-3 py-2 text-slate-600 dark:text-slate-400">19.0760° N, 72.8777° E</td>
                           <td className="px-3 py-2 text-center text-[#FF9933] font-bold">Queued</td>
                         </tr>
                       </tbody>
                     </table>
                   </div>
                 ...
                 <div className="lg:col-span-5 flex flex-col justify-between space-y-4">
                   <div className="space-y-3">
                     <h4 className="text-[11px] font-bold uppercase text-slate-600 dark:text-slate-400 border-b border-border pb-1.5 flex items-center gap-1.5">
                       <Activity className="w-3.5 h-3.5" /> Telemetry Sweep Progress
                     </h4>
                     
                     <div className="bg-slate-50 dark:bg-slate-900/30 p-3 border border-border rounded-sm">
                       <div className="flex justify-between items-center mb-2">
                         <span className="text-[10px] uppercase font-bold text-slate-600 dark:text-slate-400">Overall Scan Progress</span>
                         <span className="text-xs font-black text-[#000080] dark:text-primary">94%</span>
                       </div>
                       <div className="w-full bg-slate-200 dark:bg-slate-800 h-2 rounded-full overflow-hidden flex">
                         <div className="bg-[#138808] h-full" style={{ width: '40%' }}></div>
                         <div className="bg-[#FF9933] h-full" style={{ width: '30%' }}></div>
                         <div className="bg-[#000080] h-full" style={{ width: '24%' }}></div>
                       </div>
                       <div className="flex justify-between items-center mt-2 text-[9px] font-bold uppercase tracking-wider text-slate-500">
                         <span>Analysis</span>
                   ...
                   <div className="bg-yellow-50 dark:bg-yellow-900/10 border border-yellow-200 dark:border-yellow-700/30 p-3 rounded-sm flex gap-3 items-start">
                     <AlertTriangle className="w-4 h-4 text-yellow-600 dark:text-yellow-500 shrink-0 mt-0.5" />
                     <p className="text-[10px] text-yellow-800 dark:text-yellow-400/80 font-medium leading-relaxed">
                       Preemptive wear-and-tear models derived from SAR imagery are synced to municipal repair pipelines automatically via NICNet.
                     </p>
                   </div>
                 </div>
               </div>
