      ...
      <div className="hidden md:flex md:w-1/2 bg-[#000080] text-white p-12 flex-col justify-between relative overflow-hidden border-r-4 border-[#FF9933]">
        ...
        <div className="relative z-10 space-y-6 pt-10">
          ...
          <div className="flex items-center gap-4 bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-sm mt-8 max-w-sm shadow-lg">
            <div className="bg-white p-2 rounded-sm shadow-sm shrink-0 flex items-center justify-center">
              <img 
            ...
            <div>
              <p className="text-[10px] text-white font-bold uppercase tracking-widest drop-shadow-sm">A Government Initiative</p>
              <p className="text-sm font-black tracking-wide text-[#FF9933]">Digital India Program</p>
              <p className="text-xs text-slate-300 mt-1 leading-snug font-medium">Empowering citizens with transparent, digital governance.</p>
            </div>
          </div>
        </div>
